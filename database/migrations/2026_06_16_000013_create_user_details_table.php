...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('user_details', function (Blueprint $table) {
            ...
            $table->string('payout_bank_country', 2)->nullable();
            $table->string('payout_waiting_list_country')->nullable();
            $table->timestamp('payout_waiting_list_at')->nullable();
            ...
            $table->enum('availability_status', ['design_custom', 'design_only', 'custom_only', 'closed'])
                ->default('closed');
            $table->string('personal_page_background_image')->nullable();
            $table->string('personal_page_color')->nullable();
            $table->string('personal_page_tagline')->nullable();
            $table->string('personal_page_description')->nullable();
            $table->string('personal_page_name_alias')->nullable();
    ...
    {
        $this->dropTablesSafely('user_details');
    }
};
