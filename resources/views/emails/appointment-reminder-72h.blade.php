...
<head>
  ...
  <title>Your appointment with {{ $artistName }} is coming up</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#fdf7ff;font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Just a reminder that your appointment with {{ $artistName }} is coming up in 3 days.
  </div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                  <td style="font-size:15px;color:#494552;line-height:1.7;padding:0 0 20px 0;">
                    If you have any questions or need to get in touch with your artist before your appointment, you can do so through your booking.
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding:0 0 28px 0;">
                    <a href="{{ $viewAppointmentUrl }}" target="_blank" rel="noopener noreferrer" style="display:inline-block;background-color:#1c1b21;color:#ffffff;font-size:16px;font-weight:700;text-decoration:none;padding:14px 28px;border-radius:12px;line-height:1;">
                      View appointment
                    </a>
                  </td>
                </tr>
