...
<head>
  ...
  <title>New custom tattoo request — Inkjin</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#fdf7ff;font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    {{ $clientName }} submitted a new custom tattoo request. Review it in your Inkjin dashboard.
  </div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                  <td align="center" style="font-size:24px;font-weight:700;color:#1c1b21;line-height:1.3;padding:0 0 12px 0;">
                    New custom tattoo request
                  </td>
                </tr>
                <tr>
                  <td style="font-size:16px;color:#494552;line-height:1.6;padding:0 0 28px 0;text-align:center;">
                    <strong>{{ $clientName }}</strong> submitted a custom tattoo request.
                    Review their answers and respond when you're ready.
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding:0 0 12px 0;">
                    <a href="{{ $dashboardUrl }}" target="_blank" rel="noopener noreferrer" style="display:inline-block;background:linear-gradient(135deg,#310f7a 0%,#482d91 100%);color:#ffffff;font-size:16px;font-weight:700;text-decoration:none;padding:16px 40px;border-radius:12px;line-height:1;">
                      Open dashboard
                    </a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0 0 28px 0;font-size:12px;color:#7a7583;line-height:1.5;text-align:center;">
                    Sign in to your artist dashboard to review the request and message the client.
                  </td>
                </tr>
                @endif
                ...
                <tr>
                  <td style="font-size:14px;color:#494552;line-height:1.6;text-align:center;">
                    Responding quickly helps clients commit to working with you.
                  </td>
                </tr>
              </table>
            </td>
