...
<head>
  ...
  <title>Custom request submitted — Inkjin</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#fdf7ff;font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Your custom tattoo request with {{ $artistName }} was submitted. Track it from your Inkjin dashboard.
  </div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                  <td style="padding:0 0 28px 0;font-size:12px;color:#7a7583;line-height:1.5;text-align:center;">
                    This link signs you in to Inkjin. It expires in 14 days for your security.
                  </td>
                </tr>
                @endif
                      ...
                      <tr>
                        <td style="padding:24px;">
                          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                            ...
                            <tr><td style="font-size:15px;color:#1c1b21;"><strong>Reference:</strong> {{ $requestReference }}</td></tr>
                          </table>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="padding:0 0 6px 0;font-size:14px;color:#494552;line-height:1.6;text-align:center;">
                    You will receive another email when the artist responds with a quote or questions.
                  </td>
                </tr>
              </table>
            </td>
