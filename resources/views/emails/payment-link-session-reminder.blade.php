...
<head>
  ...
  <title>Your session with {{ $artistName }} is {{ $dayName }}</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#fdf7ff;font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Quick reminder — your session with {{ $artistName }} is {{ $dayName }} at {{ $sessionTime }}.
  </div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                  <td style="font-size:16px;color:#494552;line-height:1.7;padding:0 0 20px 0;">
                    Quick reminder — your session is coming up:
                  </td>
                </tr>
                <tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#f4efe8;border-radius:12px;">
                      <tr>
                        <td style="padding:20px 24px;font-size:15px;color:#1c1b21;line-height:1.8;">
                          ...
                          Due at session: {{ $dueAmount }}
                        </td>
                      </tr>
                    </table>
                  </td>
                </tr>
                @if(!empty($intakeIncomplete) && !empty($sessionDetailsUrl))
                <tr>
                  <td style="font-size:15px;color:#494552;line-height:1.7;padding:0 0 20px 0;">
                    One thing before {{ $dayName }}: {{ $artistName }} is still missing {{ $intakeCount }} quick answers from you.
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding:0 0 28px 0;">
                    <a href="{{ $sessionDetailsUrl }}" target="_blank" rel="noopener noreferrer" style="display:inline-block;background-color:#1c1b21;color:#ffffff;font-size:16px;font-weight:700;text-decoration:none;padding:14px 28px;border-radius:12px;line-height:1;">
                      Finish session details — 1 minute
                    </a>
                  </td>
                </tr>
                @endif
                <tr>
                  <td style="font-size:15px;color:#494552;line-height:1.7;padding:0 0 28px 0;">
                    A few tips for the day: eat beforehand, stay hydrated, and wear something that keeps the {{ $placement }} easy to reach.
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding:0 0 28px 0;">
