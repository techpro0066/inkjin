      ...
      <div class="bg-surface-container-low rounded-2xl p-6">
        ...
        <div class="space-y-3">
          <div class="relative">
            ...
            <input type="url" id="instagram" name="social_links[instagram]" value="{{ $sl['instagram'] ?? '' }}" placeholder="https://www.instagram.com/yourhandle" class="w-full px-4 py-3 rounded-xl border border-outline-variant/30 bg-white focus:ring-2 focus:ring-primary/40 transition-all text-on-surface placeholder:text-outline/50 pl-10">
