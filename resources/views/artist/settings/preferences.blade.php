      ...
      <div class="space-y-10">
        ...
        <section>
          ...
          <div class="mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div>
                <label for="hourly_rate" class="block text-[11px] uppercase tracking-wider text-on-surface-variant font-medium mb-2">Hourly rate <span class="text-red-600">*</span></label>
...
<script>
  ...
  $(function () {
    ...
    toggleGapFields();
    $('#timezone, #date_time_format, #currency, #minimum_deposit_amount, #hourly_rate, #half_day_rate, #full_day_rate, #cancellation_window, #session_type, #session_duration_minutes, #consultation_tattoo_gap_value').on('change input', function () {
