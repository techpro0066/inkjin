...
<main class="main-content flex-1 min-h-screen flex flex-col">
    <div class="flex-1 p-6 md:p-10 lg:p-12 max-w-4xl">
        ...
        <!-- Settings Tabs -->
        @include('artist.partials.settings-tabs', ['activeTab' => 'styles'])
          ...
          <div class="bg-surface-container-low rounded-2xl p-6">
            ...
            <div class="space-y-3">
              <div class="relative">
                ...
                <input type="url" id="instagram" name="social_links[instagram]" placeholder="https://www.instagram.com/inkjin" value="{{ $sl['instagram'] ?? '' }}" class="w-full text-sm border border-outline-variant/30 rounded-xl pl-10 pr-4 py-3 bg-white text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/30">
              ...
              <div class="relative">
                ...
                <input type="url" id="tiktok" name="social_links[tiktok]" placeholder="https://www.tiktok.com/@inkjin" value="{{ $sl['tiktok'] ?? '' }}" class="w-full text-sm border border-outline-variant/30 rounded-xl pl-10 pr-4 py-3 bg-white text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/30">
              ...
              <div class="relative">
                ...
                <input type="url" id="youtube" name="social_links[youtube]" placeholder="https://www.youtube.com/@inkjin" value="{{ $sl['youtube'] ?? '' }}" class="w-full text-sm border border-outline-variant/30 rounded-xl pl-10 pr-4 py-3 bg-white text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/30">
              ...
              <div class="relative">
                ...
                <input type="url" id="facebook" name="social_links[facebook]" placeholder="https://www.facebook.com/inkjin" value="{{ $sl['facebook'] ?? '' }}" class="w-full text-sm border border-outline-variant/30 rounded-xl pl-10 pr-4 py-3 bg-white text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/30">
...
<script>
    ...
    function validateClient() {
      ...
      const websiteResult = window.SocialLinkValidation.validateWebsite(website);
      if (!websiteResult.ok) {
        showErrorByServerKey('social_links.website', websiteResult.message);
        ok = false;
      }
      ['instagram', 'tiktok', 'youtube', 'facebook'].forEach((platform) => {
        const value = document.getElementById(platform).value.trim();
        const result = window.SocialLinkValidation.validatePlatform(platform, value);
        if (!result.ok) {
