  ...
  <main class="max-w-4xl mx-auto px-4 sm:px-6 py-8">
    ...
    @if($artistDesigns->count() > 0)
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="design-card bg-white rounded-2xl overflow-hidden shadow-sm border border-outline-variant/50 cursor-pointer" onclick="window.location.href='design-detail.html?design=5'">
                ...
                <div class="p-4">
                    ...
                    <a href="design-detail.html?design=5" onclick="event.stopPropagation()" class="block w-full py-2 bg-primary text-on-primary rounded-full text-sm font-semibold hover:bg-primary-container transition-colors text-center">
                        Get This Tattoo
                        </a>
                    </div>
                </div>
