...
<main class="main-content flex-1 min-h-screen">
  ...
  <script>
    ...
    function renderRequestDetail(req) {
      ...
      left.innerHTML =
        '<div class="flex items-center gap-4"><div class="w-14 h-14 rounded-full bg-primary flex items-center justify-center flex-shrink-0"><span class="text-white text-lg font-bold">' + escapeHtml(req.clientInitials) + '</span></div><div><p class="font-bold text-lg text-on-surface">' + escapeHtml(req.clientName) + '</p></div></div>' +
