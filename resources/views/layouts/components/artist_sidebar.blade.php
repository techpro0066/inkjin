<aside class="sidebar hidden lg:flex fixed top-0 left-0 bg-primary flex-col p-6 z-40" id="mobileSidebar">
  ...
  <nav class="sidebar-nav flex-1 min-h-0 overflow-y-auto flex flex-col gap-1 pr-1">
    ...
    <a href="{{ route('artist.forms.index') }}" class="nav-item {{ request()->routeIs('personal-page.index') || request()->routeIs('artist.forms.*') || request()->routeIs('portfolio.index') || request()->routeIs('artist-designs.index') || request()->routeIs('guest-spots.index') || request()->routeIs('artist.faq.*') || request()->routeIs('artist.aftercare.*') ? 'active' : '' }}">
